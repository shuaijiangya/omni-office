...
/** 贡献率分析模块的独立实现。 */
public final class ContributionRateAnalysisReportModule extends AbstractReportModule<ContributionRateAnalysisModuleData> {
    ...
    @Override
    public ModuleDescriptor<ContributionRateAnalysisModuleData> descriptor() {
        return DESCRIPTOR;
    }

    @Override
    protected void composeContent(ReportSectionBuilder section, ContributionRateAnalysisModuleData data,
                                  ReportModuleContext context) {
        section.paragraph(data.getContributionRateAnalysis());
    }
}
